...
class MainPanel(LabelViewerPanel):
    ...
    def __init__(self, parent, image, name, panel_size):
        ...
        self.add_button('HomePage/Archaeology.png', 'Archaeology', (530, 0))
        self.add_button('HomePage/GoSeeIt.png', 'GoSeeIt', (1063, 0))
        self.hide_cursor()
        self.SetFocus()
...
class LabelPanel(LabelViewerPanel):
    ...
    def __init__(self, parent, background, name, panel_size, level, back_level):
        ...
        if(level==1.1):
            ...
            self.add_button('home.png', 'main', (22, 800))
            self.add_button('Diorama/Celilo.png', 'DioramaCelilo', (412, 395))
            self.add_button('Diorama/Dipnet.png', 'DioramaDipnet', (642, 595))
            self.add_button('Diorama/Platform.png', 'DioramaPlatform', (11, 435))
            self.add_button('Diorama/Rockart.png', 'DioramaRockart', (1146, 300))
            self.add_button('Diorama/Salmon.png', 'DioramaSalmon', (900, 589))
            self.add_button('artist.png', 'Artist', (1361, 800))
        elif(level==1.3):
            self.add_button('GoSeeIt/Dalles.png', 'GoSeeItDalles', (0, 0))
            self.add_button('GoSeeIt/Tamast.png', 'GoSeeItTamast', (547, 0))
            self.add_button('GoSeeIt/Museum.png', 'GoSeeItMuseum', (1075, 0))            
            self.add_button('home.png', 'main', (22, 800))
        elif(level==2):
            self.add_button('home.png', 'main', (22, 800))
...
class MainFrame(wx.Frame):
    ...
    def __init__(self, parent, image_size):
        ...
        self.add_panel('DioramaCelilo', 2, 'Diorama')
        self.add_panel('DioramaDipnet', 2, 'Diorama')
        self.add_panel('DioramaPlatform', 2, 'Diorama')
        self.add_panel('DioramaRockart', 2, 'Diorama')
        self.add_panel('DioramaSalmon', 2, 'Diorama')
        self.add_panel('GoSeeItDalles', 2, 'GoSeeIt')
        self.add_panel('GoSeeItTamast', 2, 'GoSeeIt')
        self.add_panel('GoSeeItMuseum', 2, 'GoSeeIt')
